...
const PROJECTS = [
    {name: 'DistanciaMobile', description: 'A cross-platform app implementation of Distancia ~ Digitalizing education', github_link: 'https://github.com/selimellieh72/DistanciaMobile', technology: 'Flutter'},
